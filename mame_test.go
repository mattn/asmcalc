...
func TestLex(t *testing.T) {
	tests := []struct {
		...
		{"- -1", []TokenType{TOK_MINUS, TOK_MINUS, TOK_NUM, TOK_EOF}},
		{"0--1", []TokenType{TOK_NUM, TOK_MINUS, TOK_MINUS, TOK_NUM, TOK_EOF}},
		{"0- -1", []TokenType{TOK_NUM, TOK_MINUS, TOK_MINUS, TOK_NUM, TOK_EOF}},
		{"(-1)", []TokenType{TOK_LPAREN, TOK_MINUS, TOK_NUM, TOK_RPAREN, TOK_EOF}},
		{"x=-1", []TokenType{TOK_IDENT, TOK_ASSIGN, TOK_MINUS, TOK_NUM, TOK_EOF}},
		{"a-1", []TokenType{TOK_IDENT, TOK_MINUS, TOK_NUM, TOK_EOF}},
		{"-x", []TokenType{TOK_MINUS, TOK_IDENT, TOK_EOF}},
...
func TestCompileString(t *testing.T) {
	tests := []struct {
		...
		{`println(float("3.14"))`, "3.14000000000000012\n"},
		{`println(float("-2.5"))`, "-2.5\n"},
		{`println(float("0"))`, "0.0\n"},
		{`println(float("42"))`, "42.0\n"},
		{`println(float(".5"))`, "0.5\n"},
		{`println(float("100.001"))`, "100.00100000000000477\n"},
		{`println(float("-0.0001"))`, "-0.0001\n"},
		{`println(float("4.9999999"))`, "4.99999990000000064\n"},
		{`x = float("1.25"); println(x)`, "1.25\n"},
		{`print(float("1.5")); println(float("2.5"))`, "1.52.5\n"},
		{`println(str(float("3.14")))`, "3.14000000000000012\n"},
		{`println(str(float("-2.5")))`, "-2.5\n"},
		{`println(float(7))`, "7.0\n"},
		{`println(float(-3))`, "-3.0\n"},
		{`x = "abc"; println(str(x))`, "abc\n"},
		{`x = float("3.14"); println(str(x))`, "3.14000000000000012\n"},
		{`println(float("1.2") + 1)`, "2.20000000000000016\n"},
		{`println(1 + float("2.5"))`, "3.5\n"},
		{`println(float("10") / 4)`, "2.5\n"},
		{`println(float("3") * float("0.5"))`, "1.5\n"},
		{`println(3.14)`, "3.14000000000000012\n"},
		{`println(-2.5)`, "-2.5\n"},
		{`println(0.0)`, "0.0\n"},
		{`println(1.5 + 2.5)`, "4.0\n"},
		{`println(2.0 * 3.0)`, "6.0\n"},
		{`println(10.0 / 4.0)`, "2.5\n"},
		{`println(str(3.14))`, "3.14000000000000012\n"},
		{`x = 1.25; println(x)`, "1.25\n"},
	}
